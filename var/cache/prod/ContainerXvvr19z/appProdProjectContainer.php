...
class appProdProjectContainer extends Container
{
    ...
    {
        return $this->services['fragment.listener'] = new \Symfony\Component\HttpKernel\EventListener\FragmentListener(${($_ = isset($this->services['uri_signer']) ? $this->services['uri_signer'] : ($this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('QTs2tqbfOuG9obFgndxHGPBGKcaPkPz1geN4X0Wy8j3OS9xxWc9EtiNPJ6UYzvyn'))) && false ?: '_'}, '/_fragment');
    }
    ...
    {
        return $this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('QTs2tqbfOuG9obFgndxHGPBGKcaPkPz1geN4X0Wy8j3OS9xxWc9EtiNPJ6UYzvyn');
    }
    ...
    private function getDynamicParameter($name)
    {
        switch ($name) {
            ...
            case 'modules_translation_paths': $value = [
                ...
                51 => ($this->targetDirs[3].'/modules/ps_languageselector/translations'),
            ]; break;
    ...
    protected function getDefaultParameters()
    {
        return [
            ...
            'kernel.secret' => 'QTs2tqbfOuG9obFgndxHGPBGKcaPkPz1geN4X0Wy8j3OS9xxWc9EtiNPJ6UYzvyn',
